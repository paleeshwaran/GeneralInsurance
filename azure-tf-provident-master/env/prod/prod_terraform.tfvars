...
resourcegroup            = "pi-warehouse-prod-rg"
...
sqlserver                      = "pi-sqldb-prod-server01"
...
data_factory_name    = "pi-warehouse-prod-df"
create_data_factory  = true
managed_virtual_network_enabled = true
df_kv_secret_name    =  "sql-server-pi-dwh-prod"
#---------------------------------------------------------------------------------------------------------------------------------------------
#                                                Key Vault 
#---------------------------------------------------------------------------------------------------------------------------------------------

key_vault_name    = "piwarehouseprodkeyvault"
