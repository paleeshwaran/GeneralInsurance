/****** Object:  StoredProcedure [sp_staging].[staging_policy_sales]    Script Date: 23/12/2021 8:36:36 am ******/
SET ANSI_NULLS ON
GO
...
case when policy_status_code in( 'V','Approved' )and p.policy_valid_from_date < getdate() and p.policy_valid_to_date > getdate() then COUNT(policy_id) else null end as total_live_policy_count,
...
--user_role_key,
policy_status_code,
policy_term_in_months,p.product_code,policy_status_code,p.parent_policy_id,p.policy_valid_from_date,p.policy_valid_to_date
